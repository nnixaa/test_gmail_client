...
public class OutboxActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences settings = OutboxActivity.this.getSharedPreferences(SettingsActivity.PREF_NAME, 0);
        ...
        if (email.length() == 0 || password.length() == 0) {
            Toast.makeText(OutboxActivity.this, getString(R.string.main_need_credentials), Toast.LENGTH_SHORT).show();

            Intent intent = new Intent(OutboxActivity.this, SettingsActivity.class);
        ...
        adapter = new SimpleCursorAdapter(OutboxActivity.this,
        ...
        gmailData = new GmailDataProxy(connector, OutboxActivity.this, Reader.MESSAGE_TYPE_SENT);
        ...
        messagesListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView parent, View v, int position, long id) {
                ...
                Toast.makeText(OutboxActivity.this,cursor.getString(cursor.getColumnIndex(GmailDataProxy.DatabaseHelper.FIELD_FROM)) , Toast.LENGTH_SHORT).show();
